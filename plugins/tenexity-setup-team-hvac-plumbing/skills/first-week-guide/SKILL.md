...
When the user first triggers this skill, **don't force them through all 5 days**. Read their role from `ABOUT ME/USER/me.md` first, then suggest the days that fit their job.
...
> "Welcome to your first week with CoWork for Distributors. There are 5 days of guided tasks here — each one produces real output you keep. Not every day fits every role, though. Based on yours ([role from USER/me.md]), I'd suggest **[recommended days]**. What would you like?"
...
>
> - **Day 1:** A vendor email in your voice (no data needed — just your COMPANY voice-and-writing-rules with any USER voice override)
...
**Requires:** ABOUT ME/COMPANY/ and ABOUT ME/USER/ both populated (Setup Company and Setup User completed)
...
Draft the email using `ABOUT ME/COMPANY/voice-and-writing-rules.md` (with any `USER/my-voice.md` overrides applied). Under 150 words for most situations. Name specifics (part numbers, dates, dollars). Clear ask. Direct phone sign-off.
